...
# Repository: https://github.com/EnergyCrawler/EnergyCrawler/blob/main/config/db_config.py
...
MYSQL_DB_NAME = os.getenv("MYSQL_DB_NAME", "energycrawler")
...
MONGODB_DB_NAME = os.getenv("MONGODB_DB_NAME", "energycrawler")
...
POSTGRES_DB_NAME = os.getenv("POSTGRES_DB_NAME", "energycrawler")
