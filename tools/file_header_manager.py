...
# Repository: https://github.com/EnergyCrawler/EnergyCrawler/blob/main/tools/file_header_manager.py
...
REPO_URL = "https://github.com/EnergyCrawler/EnergyCrawler"
GITHUB_PROFILE = "https://github.com/EnergyCrawler"
EMAIL = "maintainers@energycrawler.local"
COPYRIGHT_YEAR = "2025"
...
def has_copyright_header(content: str) -> bool:
    ...
    return "Copyright (c)" in content and "EnergyCrawler project" in content
