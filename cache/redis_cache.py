...
# Repository: https://github.com/EnergyCrawler/EnergyCrawler/blob/main/cache/redis_cache.py
...
if __name__ == '__main__':
    ...
    # basic usage
    redis_cache.set("name", "EnergyCrawler Maintainer", 1)
    print(redis_cache.get("name"))  # Maintainer
