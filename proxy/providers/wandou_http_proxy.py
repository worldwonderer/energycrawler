...
# Repository: https://github.com/EnergyCrawler/EnergyCrawler/blob/main/proxy/providers/wandou_http_proxy.py
    ...
    async def get_proxy(self, num: int) -> List[IpInfoModel]:
        ...
        async with httpx.AsyncClient() as client:
            ...
            response = await client.get(
                url,
                headers={
                    "User-Agent": "EnergyCrawler https://github.com/EnergyCrawler/EnergyCrawler",
                },
            )
