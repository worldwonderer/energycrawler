...
# Repository: https://github.com/EnergyCrawler/EnergyCrawler/blob/main/media_platform/twitter/field.py
...
TWITTER_API_URL = "https://x.com/i/api"
...
class TwitterCrawlerMode(Enum):
    """Twitter crawler mode"""
    SEARCH = "search"
